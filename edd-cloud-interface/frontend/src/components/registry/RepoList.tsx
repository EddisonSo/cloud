  ...
  return (
    <div className="w-full">
      ...
      <div className="hidden md:grid grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-4 px-5 py-3 border-b border-border">
        ...
        <div className="font-mono text-[10px] font-medium uppercase tracking-[0.2em] text-faint">Visibility</div>
      </div>
      {/* Rows */}
      <div className="divide-y divide-border">
        {repos.map((repo) => (
          <div
            key={repo.name}
            className="flex flex-col gap-2 px-4 md:px-5 py-3 cursor-pointer hover:bg-popover transition-colors duration-150 md:grid md:grid-cols-[2fr_1fr_1fr_1fr_1fr] md:gap-4 md:items-center"
